...
class NetworkInterface {
  private:
    ...
    std::map<uint32_t,EthernetAddress> _mapae{};

    std::map<uint32_t,size_t> _mapat{};

    std::map<uint32_t,size_t> _reqat{};

    std::queue<InternetDatagram> _queind{};
    std::queue<uint32_t> _queip{};
